...
ggsave("output/figures/HUB-mean-scores-vs-total-log-log.png", width = 7, height = 6)

# ggsave("output/figures/HUB-mean-scores-vs-total-log-log.png", width = 7, height = 4)
...
p_cor_ranks <- correlation_ranks |>
  ...
  labs(y = "Corr. ranks single forecasts", x = "Forecast horizon")
