...
p1 + 
  ggtitle("Effect of scoring on a log scale")
```
...
p2 + 
  ggtitle("Effect of scoring on a log scale for two variables with unequal means")
```
...
p3 + 
  ggtitle("Effect of scoring on a log scale for two variables with unequal variances")
```
...
title <- "Effect of scoring on a log scale for two variables with unequal means and unequal variances"
p4 + 
  ggtitle(wrap_title(title, width = 80))
```
